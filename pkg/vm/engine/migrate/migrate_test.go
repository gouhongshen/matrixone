...
func TestXxx(t *testing.T) {
	...
	// 1. ReadCkp11File
	fromEntry, ckpbats := ReadCkp11File(fs, "ckp/meta_0-0_1727232610822354759-0.ckp")
	t.Log(fromEntry.String())

	ReplayObjectBatch(ckpbats[ObjectInfoIDX])
	...
	//}
	//RewriteCkp(fs, fromEntry, txnNode, entryNode, objDB, objTbl, objCol)
	//
	//for _, v := range objDB {
	//	t.Log(v.String())
	//}
